...
if __name__ == "__main__":
    ...
    if PCA:
        ...
        pca_path = os.path.join(MODEL_DIR, pca_filename + ".pca")
        if not os.path.exists(pca_path):
            raise FileNotFoundError(f"Fichier PCA introuvable : {pca_path}")
    ...
    with open(LOG_PATH, "a") as log_file:
        ...
        while True:
            ...
            if NORMALISATION:
                fv = apply_normalization(fv, method=NORMALISATION_METHOD)
